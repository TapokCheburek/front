    ...
    <header className="w-full bg-[#f3f4f6]">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-lg font-normal text-black">
          ...
          <Link to="/constructor" className="hover:opacity-70 transition-opacity">Конструктор</Link>
          <Link to="/preorder" className="hover:opacity-70 transition-opacity">Предзаказ</Link>
        </nav>
